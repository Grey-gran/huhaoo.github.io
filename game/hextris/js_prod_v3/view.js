<link rel="stylesheet" type="text/css" href="/hint.min.css">// t: current time, b: begInnIng value, c: change In value, d: duration
...
function showText(text) {
    ...
    messages['gameover'] += "<div class="fltrt" id="tweetStuff"><a class="tweet" href="https://twitter.com/intent/tweet?text=Can you beat my &button_hashtag=hextris score of "+ score +" points on http://hextris.github.io/hextris?" data-lang="en" data-related="hextris:hextris" target="_blank" rel="noopener">Share Your Score on Twitter!!!</a></div>"
